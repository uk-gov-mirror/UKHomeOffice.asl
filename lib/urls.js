module.exports = {
  ...
  project: {
    ...
    updateLicenceHolder: '/e/:establishmentId/projects/:projectId/update-licence-holder',
    version: {
  ...
  pil: {
    ...
    species: '/e/:establishmentId/people/:profileId/pil/:pilId/edit/animal-types',
    revoke: {
    ...
    training: {
      ...
      species: '/e/:establishmentId/people/:profileId/pil/:pilId/edit/training/species'
    },
    exemptions: {
